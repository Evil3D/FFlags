## This is a repo with all pekora fflags from different versions.
## ALSO there will be files aswell, they're labeled as such: FFlags_<first 5 characters of the version>_<version, so like 2020L>
